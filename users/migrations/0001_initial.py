    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_status', models.CharField(choices=[('new', 'new'), ('code_verified', 'code_verified'), ('done', 'done')], default='new', max_length=50)),
                ('user_type', models.CharField(choices=[('patient', 'patient'), ('doctor', 'doctor'), ('admin', 'admin')], default='patient', max_length=50)),
